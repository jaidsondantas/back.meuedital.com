...
<div>
    ...
    <input id="bearer_code_input" type="text" placeholder="Token" onchange="window.setExtraHeader(this.value)"
           style="height: 2em;width: 100%;font-size: 1em;"/>
</div>
    ...
    window.onload = function () {
        ...
        const ui = SwaggerUIBundle({
            ...
            requestInterceptor: function () {
                var token = document.getElementById('bearer_code_input').value;
