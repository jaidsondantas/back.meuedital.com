...
class NoticeContentController extends Controller
{
    ...
    {
        return $this->findAll(new NoticeContent(), $request, NoticeContent::getAliasEntity(NoticeContent::ALIAS, 'M'));
    }

    /**
     * @OA\Get(
     *     path="/notice_content/1",
     *     tags={"NoticeContent"},
     *     summary="GET NoticeContent",
     *     @OA\Parameter(
     *          ref="#/components/parameters/Authorization"
    ...
    {
        return $this->findId($id, new NoticeContent(), $request, NoticeContent::getAliasEntity(NoticeContent::ALIAS, 'M'));
    }
     ...
     *         description="Credentials object",
     *         url="http://autopecadelivery.com/api/notice_content"
     *     )
     * )
     * @OA\Post(
     *     path="/notice_content",
    ...
    {
        return $this->create(new NoticeContent(), $request, NoticeContent::getAliasEntity(NoticeContent::ALIAS, 'M'));
    }
    ...
    {
        return $this->update($id, new NoticeContent(), $request, NoticeContent::getAliasEntity(NoticeContent::ALIAS, 'M'));
    }
    ...
    {
        return $this->delete($id, new NoticeContent(), NoticeContent::getAliasEntity(NoticeContent::ALIAS, 'F'), $request);
    }
